...
It uses the **subset construction method** and provides both **graphical and tabular outputs** for better understanding.
...
* Explores states using **queue-based approach**
* Continues until no new states are found
